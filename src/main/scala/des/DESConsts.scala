...
object DESConsts {
  ...
  val ROT: Seq[Int] = Seq(1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1)

  // S-boxes: 8 boxes, each 4x16 = 64 entries (row,col) -> 4-bit
  // Each line flattened row-major for convenience: entry(row*16 + col)
  val SBOX: Array[Array[Int]] = Array(
    Array( // S1
